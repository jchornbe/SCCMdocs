...
- New device provisioning with co-management. CMG is not required for co-management when auto-enrolling existing clients, however it is required for new devices involving Windows AutoPilot, Azure AD, Microsoft Intune, and Configuration Manager. For more information, see [Paths to co-management](https://docs.microsoft.com/en-us/sccm/comanage/quickstart-paths).  
